        ...
        <div class="body-content">
            <div class="side-bar">
                <ul class="nav-links">
                    ...
                    <li class="nav-link" onclick="showContent('apply-leave')">Apply Leave <span id="leave-notification"
                                                                                                class="notification-badge">0</span>
                    </li>
                </ul>
            </div>
...
$noticeCount = $result->num_rows;
        ...
        <div class="display-content-box" id="attendance" style="display: none;">Attendance</div>
        <div class="display-content-box" id="apply-leave" style="display: none;">Apply for Leave</div>
    </div>
</div>
